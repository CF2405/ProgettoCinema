    ...
    <body>
        ...
        <div class="cont__video">
            <div class="cont__video__container">
                <iframe width="100%" height="600px" src="https://www.youtube.com/embed/DSx8Jobx-Gs" title="YouTube video player"
                    frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"  allowfullscreen>
                </iframe>
            </div>
                </div>

        <h1>BENVENUTI da GICAandCO:</h1> <h2>il cinema più grande d'Italia</h2>
        <br><br>
